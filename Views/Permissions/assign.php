                    ...
                    <table class="table db-table table-bordered">
                        ...
                        for ($i=0; $i < count($modules); $i++) {
                            ...
                            <tr>
                                ...
                                <td><input class="form-control" type="checkbox" name="module[<?php echo $i; ?>][r]" <?php echo $rCheck ?>></td>
                                <td><input class="form-control" type="checkbox" name="module[<?php echo $i; ?>][u]" <?php echo $uCheck ?>></td>
                                <td><input class="form-control" type="checkbox" name="module[<?php echo $i; ?>][d]" <?php echo $dCheck ?>></td>
                            </tr>
                            <?php
                            $n++;
                        }
